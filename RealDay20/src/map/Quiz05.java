...
//	        Set<String> realtest = myCharacter.keySet();
//	        Iterator<String> a = realtest.iterator();
//	        
//	        while(a.hasNext()) {
//	        	String x = a.next();
...
//	        }
	        ...
	        Iterator<Map<String, String>> test = charaters.iterator();
	        while (test.hasNext()) {
	        	
	        	
	        	
	        	Map<String, String> name = test.next();
	        	
	        	
	        	if(name.get("서버").equals(myCharacter.get("서버")) && name.get("직업").equals("힐러")) {
	        		 System.out.println(name);
	        		 int level = Integer.valueOf(name.get("레벨"));
	        		 if ( level > maxLevel) {
	        			 maxLevel =  level;
	        			 maxCharacter = name;
	        		 }
